...
- 理解枚举类型
  - [枚举的定义](https://blog.csdn.net/javazejian/article/details/71333103#枚举的定义)
  - [枚举实现原理](https://blog.csdn.net/javazejian/article/details/71333103#枚举实现原理)
  - 枚举的常见方法
    - [Enum抽象类常见方法](https://blog.csdn.net/javazejian/article/details/71333103#enum抽象类常见方法)
    - [编译器生成的Values方法与ValueOf方法](https://blog.csdn.net/javazejian/article/details/71333103#编译器生成的values方法与valueof方法)
- [枚举与Class对象](https://blog.csdn.net/javazejian/article/details/71333103#枚举与class对象)
- 枚举的进阶用法
  - [向enum类添加方法与自定义构造函数](https://blog.csdn.net/javazejian/article/details/71333103#向enum类添加方法与自定义构造函数)
  - [关于覆盖enum类方法](https://blog.csdn.net/javazejian/article/details/71333103#关于覆盖enum类方法)
  - [enum类中定义抽象方法](https://blog.csdn.net/javazejian/article/details/71333103#enum类中定义抽象方法)
  - [enum类与接口](https://blog.csdn.net/javazejian/article/details/71333103#enum类与接口)
- [枚举与switch](https://blog.csdn.net/javazejian/article/details/71333103#枚举与switch)
- [枚举与单例模式](https://blog.csdn.net/javazejian/article/details/71333103#枚举与单例模式)
- EnumMap
  - [EnumMap基本用法](https://blog.csdn.net/javazejian/article/details/71333103#enummap基本用法)
  - [EnumMap实现原理剖析](https://blog.csdn.net/javazejian/article/details/71333103#enummap实现原理剖析)
- EnumSet
  - [EnumSet用法](https://blog.csdn.net/javazejian/article/details/71333103#enumset用法)
  - EnumSet实现原理剖析
    - [理解位向量](https://blog.csdn.net/javazejian/article/details/71333103#理解位向量)
    - [EnumSet原理](https://blog.csdn.net/javazejian/article/details/71333103#enumset原理)
